...
export default function RequestsPage() {
  ...
  const [reqStatus, setReqStatus] = useState(selected?.status || "pending");
  ...
  if (isLoading) {
    return <div style={{ padding: 40, fontFamily: "Outfit, sans-serif" }}>Loading requests...</div>;
  }
        ...
        <div className="main" style={{ marginLeft: 0 }}>
          ...
          <div className="workspace" style={{ height: "calc(100vh - 57px)", overflow: "hidden" }}>
            ...
            <div className="req-list">
              ...
              {filtered.map((r) => (
                <div key={r.id} className={`req-item${selected?.id === r.id ? " active" : ""}`} onClick={() => { setSelectedId(r.id); setReqStatus(r.status); }}>
            ...
            {selected ? (
              <div className="detail-panel">
                <div className="detail-head">
                  ...
                  <select className="sel" value={reqStatus} onChange={(e: ChangeEvent<HTMLSelectElement>) => setReqStatus(e.target.value as any)}>
